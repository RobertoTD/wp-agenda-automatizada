...
require_once plugin_dir_path(__FILE__) . 'includes/domain/tenant/class-aa-tenant-domain.php';
...
require_once plugin_dir_path(__FILE__) . 'includes/application/canonical/capabilities/CanonicalCapabilityRecordReadState.php';
...
require_once plugin_dir_path(__FILE__) . 'includes/application/canonical/capabilities/presentation/CanonicalCapabilityPresentationDefinition.php';
require_once plugin_dir_path(__FILE__) . 'includes/application/canonical/capabilities/presentation/CanonicalCapabilityPresentationRegistry.php';
...
require_once plugin_dir_path(__FILE__) . 'includes/admin/ui/modules/canonical_shell/presenters/class-aa-canonical-dossier-shell-presenter.php';
...
require_once __DIR__ . '/includes/application/expediente/ExpedienteAdjuntoUploadTransfer.php';
...
// ================================
// 🔹 Endpoint AJAX: Registros hijos por expediente_id (sin UI aún)
// ================================
require_once __DIR__ . '/includes/http/ajax/ExpedienteRegistrosByExpedienteAjax.php';
