...
(function() {
    ...
    function createMobileTimeInput(wrapper, name, hour, minute) {
        ...
        input.className = 'aa-form-field aa-timepicker-mobile w-[7rem] px-2 py-2 text-sm border border-gray-300 rounded-lg transition-shadow';
    ...
    function createDesktopTimeSelectors(wrapper, name, hour, minute) {
        ...
        hourSelect.className = 'aa-form-field aa-time-hour w-16 px-2 py-2 text-sm border border-gray-300 rounded-lg transition-shadow bg-white';
        ...
        minuteSelect.className = 'aa-form-field aa-time-minute w-16 px-2 py-2 text-sm border border-gray-300 rounded-lg transition-shadow bg-white';
