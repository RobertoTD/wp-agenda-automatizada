<?php
/**
 * Handler de escritura whatsapp (reglas + efecto).
 * Reutiliza AA_Canonical_Phone_Normalizer como helper E.164 puro.
 *
...
final class AA_Canonical_Whatsapp_Write_Handler implements CanonicalCapabilityWriteHandler {
    ...
    public function prepare_record_write(
        ...
        if ($value === null) {
            ...
            return new AA_Canonical_Whatsapp_Clear_Effect($this->whatsapp_repository);
        }

        return new AA_Canonical_Whatsapp_Set_Effect($this->whatsapp_repository, $value);
    }
}
