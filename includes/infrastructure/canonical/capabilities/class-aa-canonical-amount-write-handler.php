<?php
/**
 * Handler de escritura amount (reglas + efecto).
 *
...
final class AA_Canonical_Amount_Write_Handler implements CanonicalCapabilityWriteHandler {
    ...
    public function prepare_record_write(
        ...
        $normalized = AA_Canonical_Amount_Normalizer::normalize($raw);
        ...
        if ($value === null) {
            ...
            return new AA_Canonical_Amount_Clear_Effect($this->amount_repository);
        }

        return new AA_Canonical_Amount_Set_Effect($this->amount_repository, $value);
    }
}
