<?php
/**
 * Handler de escritura email (reglas + efecto).
 *
...
final class AA_Canonical_Email_Write_Handler implements CanonicalCapabilityWriteHandler {
    ...
    public function __construct(
        ...
        CanonicalRecordEmailRepository $email_repository
    ) {
    ...
    public function prepare_record_write(
        ...
        $normalized = AA_Canonical_Email_Normalizer::normalize($raw);
        ...
        if ($value === null) {
            ...
            return new AA_Canonical_Email_Clear_Effect($this->email_repository);
        }

        return new AA_Canonical_Email_Set_Effect($this->email_repository, $value);
    }
}
