<?php
/**
 * Contributor whatsapp para página de registros del shell.
 *
 * @package WP_Agenda_Automatizada
 * @subpackage Application\Canonical\Capabilities\Whatsapp
 */

defined('ABSPATH') or die('No direct access');

final class CanonicalWhatsappRecordsPageContributor implements CanonicalCapabilityRecordPageContributor {
    ...
    public function __construct(
        ...
        CanonicalRecordWhatsappRepository $whatsapp_repo,
        AA_Canonical_Capability_Registry $capability_registry
    ) {
        $this->config_repo = $config_repo;
        $this->whatsapp_repo = $whatsapp_repo;
    ...
    public function contribute_for_records_page(
        ...
        $records = [];
        try {
            $batch = $this->whatsapp_repo->find_whatsapps_by_record_ids($record_ids);
