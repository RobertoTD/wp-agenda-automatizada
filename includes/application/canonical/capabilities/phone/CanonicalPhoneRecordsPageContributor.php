<?php
/**
 * Contributor phone para página de registros del shell.
 *
 * @package WP_Agenda_Automatizada
 * @subpackage Application\Canonical\Capabilities\Phone
 */

defined('ABSPATH') or die('No direct access');

final class CanonicalPhoneRecordsPageContributor implements CanonicalCapabilityRecordPageContributor {
    ...
    public function __construct(
        ...
        CanonicalRecordPhoneRepository $phone_repo,
        AA_Canonical_Capability_Registry $capability_registry
    ) {
        $this->config_repo = $config_repo;
        $this->phone_repo = $phone_repo;
    ...
    public function contribute_for_records_page(
        ...
        $records = [];
        try {
            $batch = $this->phone_repo->find_phones_by_record_ids($record_ids);
