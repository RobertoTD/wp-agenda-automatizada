<?php
/**
 * Canonical Read Binding Not Found — Binding de lectura ausente.
 *
...
final class CanonicalReadBindingNotFound extends \RuntimeException {
    ...
    public function __construct(string $qualified_key) {
        ...
        parent::__construct(
            sprintf('[binding_not_found] No read adapter bound for "%s".', $qualified_key)
        );
    }
