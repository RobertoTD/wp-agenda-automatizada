<?php
/**
 * Canonical Update Record AJAX — edición productiva de registros universales (SB1-5B3).
 *
...
final class CanonicalUpdateRecordAjax {

    public const ACTION = 'aa_update_canonical_record';
    public const NONCE_ACTION = 'aa_update_canonical_record';
        ...
        try {
            ...
            if (strpos($msg, '[title_too_long]') === 0) {
                self::error(
                    ...
                    . CanonicalUpdateRecordCommand::MAX_TITLE_LENGTH
                    . ' caracteres.',
                    400
                );
            }
    ...
    private static function require_dependencies(): void {
        ...
        if (!class_exists('CanonicalUpdateRecordCommand')) {
            require_once dirname(__DIR__, 2) . '/application/canonical/CanonicalUpdateRecordCommand.php';
        }
