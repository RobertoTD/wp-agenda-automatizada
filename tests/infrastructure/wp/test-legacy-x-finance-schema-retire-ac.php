...
echo "=== 1. Contención estática Schema DB24 ===\n";
$schema_src = (string) file_get_contents($plugin_root . '/includes/infrastructure/wp/Schema.php');
ac_assert('DB_VERSION = 24', strpos($schema_src, "DB_VERSION = '24'") !== false);
...
try {
    ...
    ac_assert('aa_db_version consolidada a 24', (string) get_option('aa_db_version', '0') === '24');
