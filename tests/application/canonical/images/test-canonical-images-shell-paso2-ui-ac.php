...
ac_assert('DEFAULTS_VERSION = 4', strpos($defaults, 'public const DEFAULTS_VERSION = 4;') !== false);
...
ac_assert('DB_VERSION = 32', strpos($db_schema, "public const DB_VERSION = '32';") !== false);
