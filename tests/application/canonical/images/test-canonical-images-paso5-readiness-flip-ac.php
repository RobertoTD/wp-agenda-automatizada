<?php
/**
 * AC Paso 5 — flip readiness images + DEFAULTS_VERSION=6.
 *
 * Tres baterías:
...
ac_assert('DEFAULTS_VERSION=6', strpos($life, 'public const DEFAULTS_VERSION = 6;') !== false);
ac_assert('DB_VERSION actual 34', strpos($schema, "public const DB_VERSION = '34';") !== false);
...
try {
    ...
    update_option('aa_db_version', '32');
