...
ac_assert(
    ...
    && strpos($detail, 'deleteRegistro: true') !== false
    && strpos($detail, 'aa_update_expediente_registro_for_expediente') !== false
    && strpos($detail, 'aa_delete_expediente_registro_for_expediente') !== false
...
ac_assert(
    'detalle actions incluyen deleteRegistro',
    strpos($detail, 'deleteRegistro:') !== false
    && strpos($detail, 'ACTION_DELETE') !== false
);
ac_assert(
...
ac_assert(
    ...
    && strpos($rendered_detail, 'deleteRegistro: true') !== false
