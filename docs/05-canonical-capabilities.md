...
- **IMG-5 inc. 4:** `DB_VERSION=30`; `RetireCanonicalContainerUseCase` + `aa_delete_canonical_container`; seal obligatorio (incl. count=0); chunks keyset post-sello; modal de lista. AC aislados PASS. Policyytest 2026-09-14: blog 61 schema 29→30; AJAX A/B/C PASS; Continuar visual desde listado lista 22 PASS (§7.12); Cerrar/recargar/banner pendientes; lista 21 primer intento no PASS (§7.11). Retiro de una imagen (§8 del plan) pendiente aparte.
