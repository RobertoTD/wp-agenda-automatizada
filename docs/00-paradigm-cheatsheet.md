...
> **Canon DEO — fuente autoritativa:** `docs/04-canonical-constitution.md`. **Destino normativo:** listas y registros sin familia; capabilities globales configurables por lista; raíz única; sin presets, clasificadores ni solutions en esta etapa. **Estado implementado transitorio:** `DB_VERSION=38` conserva familia/repertorio/`contact_dossier` v1 y debe retirarse conforme a `docs/plans/canonical-free-v2.md`. El shell administrativo y el futuro runtime público son consumidores distintos del mismo núcleo horizontal.

> **Solutions canónicas:** `docs/06-canonical-solutions.md` conserva la frontera conceptual. No hay una solution activa: `contact_dossier` se retira en Canon libre v2.
