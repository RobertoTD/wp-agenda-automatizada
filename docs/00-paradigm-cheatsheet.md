...
- `canonical`: núcleo operativo en transición. El camino activo usa `DB_VERSION=39`, listas y registros sin Family y una superficie C1 mínima. FH-1 consolidará el contrato horizontal e integridad; FH-2 construirá el shell limpio. Registries de Family/capabilities/solutions, `contact_dossier`, sus applications y el shell legacy son antecedentes desregistrados: no son referencia para trabajo nuevo.
