...
> **Canon DEO — fuente autoritativa:** `docs/04-canonical-constitution.md`. **Estado implementado:** `DB_VERSION=40` deja listas y registros sin Family; FH-1 consolidó el puerto/repository horizontal y la FK registro→lista. **Etapa activa:** shell administrativo limpio; ver `docs/plans/canonical-horizontal-foundation-v2.md`. Capabilities, runtime público, clasificadores, búsqueda, presets y solutions no se implementan ni se adelantan en esta etapa. El shell no conoce extensiones particulares.
